...
insert into users(name, forname, birthdate, telephone, email, idrole, password) values ('Rabe', 'Zaka', '1994-04-28', '0344194574', 'rabe@gmail.com', 1, md5('rabe123'));
insert into users(name, forname, birthdate, telephone, email, idrole, password) values ('Ravao', 'Marie', '1992-08-24', '0327294247', 'ravao@gmail.com', 1, md5('ravao123'));
insert into users(name, forname, birthdate, telephone, email, idrole, password) values ('Rasoa', 'Jeanne', '1998-02-20', '0337454411', 'rasoa@gmail.com', 2, md5('rasoa123'));
insert into users(name, forname, birthdate, telephone, email, idrole, password) values ('Rajean', 'Luc', '1980-10-03', '0342122529', 'rajean@gmail.com', 2, md5('rajean123'));
...
insert into driver (idusers, registration, idbrand, isavailable, estimationPrice) values (1, '8596 TBE', 1, 1, 5000);

insert into driver (idusers, registration, idbrand, isavailable, estimationPrice) values (2, '8292 TBD', 1, 1, 4000);

insert into driver (idusers, registration, idbrand, isavailable, estimationPrice) values (3, '8998 WWT', 5, 1, 4500);
